          ...
          <div class="row">
            <div class="col-xl-4 col-lg-6">
              <div class="footer-widget footer-widget__about">
                <a href="/" class="logo">
                  <img src="/assets/images/logo-1-2.png" width="136" alt="">
                </a>
              ...
              <div class="footer-widget footer-widget__contact">
                ...
                <ul class="footer-widget__contact-list list-unstyled">
                  ...
                  <li>
                    ...
                    <a href="mailto:needhelp@oapee.com">needhelp<b class="fonte">@</b>oapee.com</a>
                  </li>
                  <li>
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="footer-widget footer-widget__newsletter">
                ...
                <p>Sign up for our latest news <b class="fonte">&</b> articles. We won’t give you spam mails.</p>
        ...
        <div class="container">
          <div class="inner-container">
            ...
            <div class="footer-social">
              <a href="https://www.facebook.com/pen6.mkt?mibextid=wwXIfr&mibextid=wwXIfr" target="_blank"><i class="fab fa-facebook-square"></i></a>
              <a href="#"><i class="fab fa-twitter"></i></a>
              <a href="https://www.instagram.com/pen6.mkt?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank"><i class="fab fa-instagram"></i></a>
